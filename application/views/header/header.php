...
<!--                         <li><i class="fa fa-phone"></i><span>+1 456 6717</span></li>
 ...
 -->                    </ul>
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="index.html"><img src="<?php echo base_url(); ?>/assets/frontend/layout/img/logos/logo-corp-blue.png" alt="Metronic FrontEnd"></a>

        <a href="javascript:void(0);" class="mobi-toggler"><i class="fa fa-bars"></i></a>

        <!-- BEGIN NAVIGATION -->
        <div class="header-navigation pull-right font-transform-inherit" style="padding-top: 25px; width: 70%;">
          <ul>
            <li>
