          ...
          <div class="col-md-4 col-sm-6 pre-footer-col">
            ...
            <div class="photo-stream">
              ...
              <ul class="list-unstyled">
                <li><a href="#"><img alt="" src="<?php echo base_url(); ?>/assets/frontend/pages/img/people/img5-small.jpg"></a></li>
                <li><a href="#"><img alt="" src="<?php echo base_url(); ?>/assets/frontend/pages/img/works/img1.jpg"></a></li>
                <li><a href="#"><img alt="" src="<?php echo base_url(); ?>/assets/frontend/pages/img/people/img4-large.jpg"></a></li>
                <li><a href="#"><img alt="" src="<?php echo base_url(); ?>/assets/frontend/pages/img/works/img6.jpg"></a></li>
                <li><a href="#"><img alt="" src="<?php echo base_url(); ?>/assets/frontend/pages/img/works/img3.jpg"></a></li>
                <li><a href="#"><img alt="" src="<?php echo base_url(); ?>/assets/frontend/pages/img/people/img2-large.jpg"></a></li>
                <li><a href="#"><img alt="" src="<?php echo base_url(); ?>/assets/frontend/pages/img/works/img2.jpg"></a></li>
                <li><a href="#"><img alt="" src="<?php echo base_url(); ?>/assets/frontend/pages/img/works/img5.jpg"></a></li>
                <li><a href="#"><img alt="" src="<?php echo base_url(); ?>/assets/frontend/pages/img/people/img5-small.jpg"></a></li>
                <li><a href="#"><img alt="" src="<?php echo base_url(); ?>/assets/frontend/pages/img/works/img1.jpg"></a></li>
                <li><a href="#"><img alt="" src="<?php echo base_url(); ?>/assets/frontend/pages/img/people/img4-large.jpg"></a></li>
                <li><a href="#"><img alt="" src="<?php echo base_url(); ?>/assets/frontend/pages/img/works/img6.jpg"></a></li>
